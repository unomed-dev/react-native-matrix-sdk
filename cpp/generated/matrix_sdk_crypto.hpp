...
public:
   ...
   *
   * React Native must call `NativeMatrixSdkCrypto.registerModule(rt,
   ...
   * be the case.
   *
   * Clients should call `NativeMatrixSdkCrypto.unregisterModule(rt)` after
