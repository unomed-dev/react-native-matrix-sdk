...
// Callback function: uniffi::matrix_sdk::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::matrix_sdk::st::foreignfuture::foreignfuture::free::makeCallbackFunction(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructU8>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI8> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructI8>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU16> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructU16>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI16> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructI16>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructU32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructI32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructU64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructI64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteF32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructF32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteF64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructF64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompletePointer> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructPointer>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteRustBuffer> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructRustBuffer>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteVoid> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk::Bridging<UniffiForeignFutureStructVoid>::fromJs(rt, callInvoker, args[1])
        );
...
jsi::Value NativeMatrixSdk::cpp_uniffi_matrix_sdk_fn_clone_oauthauthorizationdata(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
        ...
        auto value = uniffi_matrix_sdk_fn_clone_oauthauthorizationdata(uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]), 
            &status
        );
...
jsi::Value NativeMatrixSdk::cpp_uniffi_matrix_sdk_fn_free_oauthauthorizationdata(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
        RustCallStatus status = uniffi::matrix_sdk::Bridging<RustCallStatus>::rustSuccess(rt);
        uniffi_matrix_sdk_fn_free_oauthauthorizationdata(uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]), 
            &status
        );
        uniffi::matrix_sdk::Bridging<RustCallStatus>::copyIntoJs(rt, callInvoker, status, args[count - 1]);
...
jsi::Value NativeMatrixSdk::cpp_uniffi_matrix_sdk_fn_method_oauthauthorizationdata_login_url(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
        RustCallStatus status = uniffi::matrix_sdk::Bridging<RustCallStatus>::rustSuccess(rt);
        auto value = uniffi_matrix_sdk_fn_method_oauthauthorizationdata_login_url(uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]), 
            &status
        );
        uniffi::matrix_sdk::Bridging<RustCallStatus>::copyIntoJs(rt, callInvoker, status, args[count - 1]);
