...
NativeMatrixSdk::NativeMatrixSdk(
  ...
  props["ubrn_uniffi_matrix_sdk_fn_clone_oauthauthorizationdata"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_matrix_sdk_fn_clone_oauthauthorizationdata"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_matrix_sdk_fn_clone_oauthauthorizationdata(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_matrix_sdk_fn_free_oauthauthorizationdata"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_matrix_sdk_fn_free_oauthauthorizationdata"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_matrix_sdk_fn_free_oauthauthorizationdata(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_matrix_sdk_fn_method_oauthauthorizationdata_login_url"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_matrix_sdk_fn_method_"
                                        "oauthauthorizationdata_login_url"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_matrix_sdk_fn_method_oauthauthorizationdata_login_url(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_matrix_sdk_checksum_method_oauthauthorizationdata_login_"
      ...
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_matrix_sdk_checksum_method_oauthauthorizationdata_login_url(
                rt, thisVal, args, count);
      });
  ...
  props["ubrn_uniffi_internal_fn_method_oauthauthorizationdata_ffi__bless_"
        "pointer"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt,
                                "ubrn_uniffi_internal_fn_method_"
                                "oauthauthorizationdata_ffi__bless_pointer"),
      1,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_internal_fn_method_oauthauthorizationdata_ffi__bless_pointer(
                rt, thisVal, args, count);
      });
}
...
jsi::Value
NativeMatrixSdk::cpp_uniffi_matrix_sdk_fn_clone_oauthauthorizationdata(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
