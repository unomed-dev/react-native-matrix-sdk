...
template <> struct Bridging<RustBuffer> {
  ...
  static RustBuffer fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    try {
      ...
      RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
      auto buf = ffi_matrix_sdk_rustbuffer_from_bytes(bytes, &status);
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    try {
      static auto callback =
          uniffi::matrix_sdk::cb::rustfuturecontinuationcallback::
...
NativeMatrixSdk::NativeMatrixSdk(
  ...
  props["uniffi_matrix_sdk_fn_clone_oidcauthorizationdata"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_matrix_sdk_fn_clone_oidcauthorizationdata"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
  ...
  props["uniffi_matrix_sdk_fn_free_oidcauthorizationdata"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_matrix_sdk_fn_free_oidcauthorizationdata"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
  ...
  props["uniffi_matrix_sdk_fn_method_oidcauthorizationdata_login_url"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
  ...
  props["uniffi_matrix_sdk_checksum_method_oidcauthorizationdata_login_url"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "uniffi_matrix_sdk_checksum_method_"
  ...
  props["ffi_matrix_sdk_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
  ...
  props["uniffi_internal_fn_method_oidcauthorizationdata_ffi__bless_pointer"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt,
