...
void *uniffi_matrix_sdk_fn_clone_oidcauthorizationdata(
    void *ptr, RustCallStatus *uniffi_out_err);
void uniffi_matrix_sdk_fn_free_oidcauthorizationdata(
    void *ptr, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_matrix_sdk_fn_method_oidcauthorizationdata_login_url(
    void *ptr, RustCallStatus *uniffi_out_err);
...
RustBuffer ffi_matrix_sdk_rustbuffer_from_bytes(ForeignBytes bytes,
                                                RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_rustbuffer_free(RustBuffer buf,
                                    RustCallStatus *uniffi_out_err);
RustBuffer ffi_matrix_sdk_rustbuffer_reserve(RustBuffer buf,
                                             uint64_t additional,
                                             RustCallStatus *uniffi_out_err);
...
void ffi_matrix_sdk_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_matrix_sdk_checksum_method_oidcauthorizationdata_login_url();
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_matrix_sdk_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_matrix_sdk_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_matrix_sdk_rustbuffer_from_bytes(bytes, &status);
  }
...
// Callback function:
// uniffi::matrix_sdk::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
// This method is called from the destructor of NativeMatrixSdk, which only
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::matrix_sdk::cb::rustfuturecontinuationcallback::
...
NativeMatrixSdk::NativeMatrixSdk(
  ...
  props["ubrn_uniffi_matrix_sdk_fn_clone_oidcauthorizationdata"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_matrix_sdk_fn_clone_oidcauthorizationdata"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_matrix_sdk_fn_clone_oidcauthorizationdata(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_matrix_sdk_fn_free_oidcauthorizationdata"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_matrix_sdk_fn_free_oidcauthorizationdata"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_matrix_sdk_fn_free_oidcauthorizationdata(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_matrix_sdk_fn_method_oidcauthorizationdata_login_url"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_matrix_sdk_fn_method_"
                                        "oidcauthorizationdata_login_url"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_matrix_sdk_fn_method_oidcauthorizationdata_login_url(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_matrix_sdk_checksum_method_oidcauthorizationdata_login_"
        "url"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_matrix_sdk_checksum_method_"
                                    "oidcauthorizationdata_login_url"),
      0,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
  ...
  props["ubrn_ffi_matrix_sdk_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_ffi_matrix_sdk_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_matrix_sdk_uniffi_contract_version(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_internal_fn_method_oidcauthorizationdata_ffi__bless_"
        "pointer"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_internal_fn_method_"
                                    "oidcauthorizationdata_ffi__bless_pointer"),
      1,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
...
void NativeMatrixSdk::registerModule(
...
NativeMatrixSdk::getPropertyNames(jsi::Runtime &rt) {
...
void NativeMatrixSdk::set(jsi::Runtime &rt, const jsi::PropNameID &name,
                          const jsi::Value &value) {
...
jsi::Value
NativeMatrixSdk::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(
...
jsi::Value
NativeMatrixSdk::cpp_uniffi_internal_fn_func_ffi__string_to_arraybuffer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value
NativeMatrixSdk::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  return uniffi_jsi::Bridging<std::string>::arraybuffer_to_string(rt, args[0]);
}
jsi::Value NativeMatrixSdk::
    cpp_uniffi_internal_fn_method_oidcauthorizationdata_ffi__bless_pointer(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto pointer =
  ...
  auto static destructor = [](uint64_t p) {
    ...
    uniffi_matrix_sdk_fn_free_oidcauthorizationdata(pointer, &status);
  };
  auto ptrObj =
...
jsi::Value
NativeMatrixSdk::cpp_uniffi_matrix_sdk_fn_clone_oidcauthorizationdata(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::matrix_sdk::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_matrix_sdk_fn_clone_oidcauthorizationdata(
...
jsi::Value NativeMatrixSdk::cpp_uniffi_matrix_sdk_fn_free_oidcauthorizationdata(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::matrix_sdk::Bridging<RustCallStatus>::rustSuccess(rt);
...
jsi::Value NativeMatrixSdk::
  ...
  RustCallStatus status =
      uniffi::matrix_sdk::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_matrix_sdk_fn_method_oidcauthorizationdata_login_url(
      uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]), &status);
  uniffi::matrix_sdk::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);
...
jsi::Value NativeMatrixSdk::cpp_ffi_matrix_sdk_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
