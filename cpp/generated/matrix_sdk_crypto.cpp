...
RustBuffer
ffi_matrix_sdk_crypto_rustbuffer_from_bytes(ForeignBytes bytes,
                                            RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_crypto_rustbuffer_free(RustBuffer buf,
                                           RustCallStatus *uniffi_out_err);
RustBuffer
ffi_matrix_sdk_crypto_rustbuffer_reserve(RustBuffer buf, uint64_t additional,
                                         RustCallStatus *uniffi_out_err);
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::matrix_sdk_crypto::Bridging<T>::fromJs(rt, callInvoker,
                                                            pointee);
    }
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_matrix_sdk_crypto_rustbuffer_alloc(size, &status);
  }
  ...
  static RustBuffer fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    try {
      ...
      RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
      auto buf = ffi_matrix_sdk_crypto_rustbuffer_from_bytes(bytes, &status);
  ...
  static jsi::Value toJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    ffi_matrix_sdk_crypto_rustbuffer_free(buf, &status);
...
// Callback function:
// uniffi::matrix_sdk_crypto::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
// This method is called from the destructor of NativeMatrixSdkCrypto, which
...
// Callback function:
// uniffi::matrix_sdk_crypto::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::matrix_sdk_crypto::st::foreignfuture::
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_crypto::Bridging<
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    try {
      static auto callback =
          uniffi::matrix_sdk_crypto::cb::rustfuturecontinuationcallback::
...
NativeMatrixSdkCrypto::NativeMatrixSdkCrypto(
  ...
  props["ffi_matrix_sdk_crypto_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ffi_matrix_sdk_crypto_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
...
jsi::Value NativeMatrixSdkCrypto::get(jsi::Runtime &rt,
...
NativeMatrixSdkCrypto::getPropertyNames(jsi::Runtime &rt) {
...
void NativeMatrixSdkCrypto::set(jsi::Runtime &rt, const jsi::PropNameID &name,
                                const jsi::Value &value) {
...
jsi::Value
NativeMatrixSdkCrypto::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(
