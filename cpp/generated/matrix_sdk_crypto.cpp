...
extern "C" {
    ...
    void ffi_matrix_sdk_crypto_rust_future_poll_pointer(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_crypto_rust_future_cancel_pointer(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_crypto_rust_future_free_pointer(
        /*handle*/ uint64_t handle
    );
    void * ffi_matrix_sdk_crypto_rust_future_complete_pointer(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
...
// Callback function: uniffi::matrix_sdk_crypto::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the lambda sometime in the
// future.
namespace uniffi::matrix_sdk_crypto::st::foreignfuture::foreignfuture::free {
    using namespace facebook;
    ...
    makeCallbackFunction( // uniffi::matrix_sdk_crypto::st::foreignfuture::foreignfuture::free
                    jsi::Runtime &rt,
                     std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
                     const jsi::Value &value) {
        if (rsLambda != nullptr) {
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::matrix_sdk_crypto::st::foreignfuture::foreignfuture::free::makeCallbackFunction(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructU8>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI8> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructI8>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU16> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructU16>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI16> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructI16>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructU32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructI32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructU64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructI64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteF32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructF32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteF64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructF64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompletePointer> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructPointer>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteRustBuffer> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructRustBuffer>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteVoid> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_crypto::Bridging<UniffiForeignFutureStructVoid>::fromJs(rt, callInvoker, args[1])
        );
...
uniffi::matrix_sdk_crypto::st::foreignfuture::foreignfuture::free::cleanup();
}
