...
RustBuffer ffi_matrix_sdk_ui_rustbuffer_alloc(uint64_t size,
                                              RustCallStatus *uniffi_out_err);
RustBuffer
ffi_matrix_sdk_ui_rustbuffer_from_bytes(ForeignBytes bytes,
                                        RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_ui_rustbuffer_free(RustBuffer buf,
                                       RustCallStatus *uniffi_out_err);
RustBuffer ffi_matrix_sdk_ui_rustbuffer_reserve(RustBuffer buf,
                                                uint64_t additional,
                                                RustCallStatus *uniffi_out_err);
...
double ffi_matrix_sdk_ui_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_ui_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_ui_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_ui_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_matrix_sdk_ui_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::matrix_sdk_ui::Bridging<T>::fromJs(rt, callInvoker,
                                                        pointee);
    }
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_matrix_sdk_ui_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_matrix_sdk_ui_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_matrix_sdk_ui_rustbuffer_from_bytes(bytes, &status);
  }
...
// Callback function:
// uniffi::matrix_sdk_ui::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
// This method is called from the destructor of NativeMatrixSdkUi, which only
...
// Callback function:
// uniffi::matrix_sdk_ui::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::matrix_sdk_ui::st::foreignfuture::foreignfuture::free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::matrix_sdk_ui::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::matrix_sdk_ui::st::foreignfuture::foreignfuture::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status =
        uniffi::matrix_sdk_ui::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructU8>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteI8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructI8>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructU16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructI16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructU32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructI32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructU64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructI64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructF32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructF64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteVoid> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureStructVoid>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::matrix_sdk_ui::cb::rustfuturecontinuationcallback::
...
NativeMatrixSdkUi::NativeMatrixSdkUi(
  ...
  props["ubrn_ffi_matrix_sdk_ui_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_ffi_matrix_sdk_ui_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_matrix_sdk_ui_uniffi_contract_version(
                rt, thisVal, args, count);
          });
}

void NativeMatrixSdkUi::registerModule(
...
jsi::Value NativeMatrixSdkUi::get(jsi::Runtime &rt,
...
NativeMatrixSdkUi::getPropertyNames(jsi::Runtime &rt) {
...
void NativeMatrixSdkUi::set(jsi::Runtime &rt, const jsi::PropNameID &name,
                            const jsi::Value &value) {
...
NativeMatrixSdkUi::~NativeMatrixSdkUi() {
  ...
  uniffi::matrix_sdk_ui::st::foreignfuture::foreignfuture::free::cleanup();
}

// Utility functions for serialization/deserialization of strings.
jsi::Value
NativeMatrixSdkUi::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(
...
jsi::Value
NativeMatrixSdkUi::cpp_uniffi_internal_fn_func_ffi__string_to_arraybuffer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value
NativeMatrixSdkUi::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value NativeMatrixSdkUi::cpp_ffi_matrix_sdk_ui_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
