...
protected:
  ...
  cpp_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_server_name_or_homeserver_url(
      ...
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_cache_size(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_journal_size_limit(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_passphrase(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_paths(
      ...
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_pool_max_size(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  ...
  cpp_uniffi_matrix_sdk_ffi_fn_method_room_subscribe_to_knock_requests(
      ...
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_fn_method_room_subscribe_to_live_location_shares(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  ...
  cpp_uniffi_matrix_sdk_ffi_fn_init_callback_vtable_knockrequestslistener(
      ...
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_fn_init_callback_vtable_livelocationsharelistener(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  ...
  jsi::Value cpp_uniffi_matrix_sdk_ffi_fn_func_create_caption_edit(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_matrix_sdk_ffi_fn_func_enable_sentry_logging(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  ...
  jsi::Value cpp_uniffi_matrix_sdk_ffi_checksum_func_create_caption_edit(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_matrix_sdk_ffi_checksum_func_enable_sentry_logging(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  ...
  cpp_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_server_name_or_homeserver_url(
      ...
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_cache_size(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_journal_size_limit(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_passphrase(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_paths(
      ...
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_pool_max_size(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  ...
  cpp_uniffi_matrix_sdk_ffi_checksum_method_room_subscribe_to_knock_requests(
      ...
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_checksum_method_room_subscribe_to_live_location_shares(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
  ...
  cpp_uniffi_matrix_sdk_ffi_checksum_method_knockrequestslistener_call(
      ...
      size_t count);
  jsi::Value
  cpp_uniffi_matrix_sdk_ffi_checksum_method_livelocationsharelistener_call(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value
